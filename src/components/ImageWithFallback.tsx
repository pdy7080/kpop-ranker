...
const KOREAN_TRACK_MAP = {
  '사랑은 늘 도망가': 'Love_Always_Runs_Away',
  '에피소드': 'episode',
  '천국보다 아름다운': 'Heaven_More_Beautiful',
  '우리들의 블루스': 'Our_Blues',
  '다시 만날 수 있을까': 'Can_We_Meet_Again',
  '이제 나만 믿어요': 'Trust_Only_Me_Now',
  '모래 알갱이': 'Grain_of_Sand',
  '청춘만화': 'Youth_Comic',
  '온기': 'Warmth',
  '보금자리': 'Home',
  '무지개': 'Rainbow',
  '별빛 같은 나의 사랑아': 'My_Starlight_Love',
  '사랑인가 봐': 'It_Must_Be_Love',
  '밤편지': 'Through_the_Night',
  '스물셋': 'Twenty_Three',
  '팔레트': 'Palette',
  '좋은 날': 'Good_Day',
  '너랑 나': 'You_and_I',
