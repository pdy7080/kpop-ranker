...
const defaultTranslations: Record<string, any> = {
  ko: {
    ...
    // About Page
    'about.title': '소개',
    'about.description': 'Smart AI 기반 실시간 K-POP 차트 모니터링 플랫폼',
    'about.hero.title1': '스마트한',
    'about.hero.title2': 'K-POP 차트 플랫폼',
    'about.hero.description': 'KPOP Ranker는 전 세계 K-POP 차트를 실시간으로 모니터링하고, 트렌드를 분석하며, AI 기술로 인사이트를 제공합니다.',
    'about.tech.title': '핵심 기술',
    'about.stage1.title': '실시간 데이터 수집',
    'about.stage1.description': '전 세계 8개 음원 플랫폼에서 매시간 최신 차트 데이터를 수집합니다',
    'about.stage1.badge': '100% 자동화',
    'about.stage2.title': '스마트 이미지 시스템',
    'about.stage2.description': '6단계 지능형 매칭 알고리즘으로 0.05ms 응답 속도의 앨범 이미지를 제공합니다',
    'about.stage2.badge': 'AI 기반',
    'about.stage3.title': '트렌드 분석',
    'about.stage3.description': '독자적인 스코어링 알고리즘으로 여러 차트의 실시간 트렌드를 분석합니다',
    'about.stage3.badge': '멀티 차트 분석',
    'about.features.title': '주요 기능',
    'about.feature1.title': '실시간 모니터링',
    'about.feature1.description': '멜론, 지니, 벅스, 바이브, 플로, 스포티파이, 유튜브 뮤직, 빌보드의 차트 변화를 실시간으로 추적합니다.',
    'about.feature2.title': '포트폴리오 관리',
    'about.feature2.description': '나만의 K-POP 포트폴리오를 만들고 좋아하는 아티스트의 성과를 추적하세요.',
    'about.mission.title': '우리의 미션',
    'about.mission.description': '전 세계 K-POP 팬들에게 가장 정확하고 빠른 차트 정보를 제공하여, K-POP 문화의 글로벌 성장을 지원합니다.',
  },
  en: {
    ...
    // About Page
    'about.title': 'About',
    'about.description': 'Real-time K-POP chart monitoring platform powered by Smart AI',
    'about.hero.title1': 'Smart',
    'about.hero.title2': 'K-POP Chart Platform',
    'about.hero.description': 'KPOP Ranker monitors global K-POP charts in real-time, analyzes trends, and provides insights with AI technology.',
    'about.tech.title': 'Core Technology',
    'about.stage1.title': 'Real-time Data Collection',
    'about.stage1.description': 'Collecting the latest chart data from 8 global music platforms every hour',
    'about.stage1.badge': '100% Automated',
    'about.stage2.title': 'Smart Image System',
    'about.stage2.description': '6-stage intelligent matching algorithm provides album images with 0.05ms response time',
    'about.stage2.badge': 'AI Powered',
    'about.stage3.title': 'Trend Analysis',
    'about.stage3.description': 'Proprietary scoring algorithm analyzes real-time trends across multiple charts',
    'about.stage3.badge': 'Multi-Chart Analysis',
    'about.features.title': 'Key Features',
    'about.feature1.title': 'Real-time Monitoring',
    'about.feature1.description': 'Track chart changes from Melon, Genie, Bugs, Vibe, FLO, Spotify, YouTube Music, and Billboard in real-time.',
    'about.feature2.title': 'Portfolio Management',
    'about.feature2.description': 'Create your own K-POP portfolio and track your favorite artists\' performance.',
    'about.mission.title': 'Our Mission',
    'about.mission.description': 'We are committed to providing the most accurate and fastest K-POP chart information to fans worldwide, supporting the global growth of K-POP culture.',
  },
  ja: {
    ...
    // About Page
    'about.title': '紹介',
    'about.description': 'Smart AIを活用したリアルタイムK-POPチャートモニタリングプラットフォーム',
    'about.hero.title1': 'スマートな',
    'about.hero.title2': 'K-POPチャートプラットフォーム',
    'about.hero.description': 'KPOP Rankerは世界中のK-POPチャートをリアルタイムで監視し、トレンドを分析し、AI技術でインサイトを提供します。',
    'about.tech.title': 'コア技術',
    'about.stage1.title': 'リアルタイムデータ収集',
    'about.stage1.description': '世界8つの音楽プラットフォームから毎時間最新のチャートデータを収集',
    'about.stage1.badge': '100%自動化',
    'about.stage2.title': 'スマートイメージシステム',
    'about.stage2.description': '6段階のインテリジェントマッチングアルゴリズムで0.05msの応答速度でアルバム画像を提供',
    'about.stage2.badge': 'AIパワード',
    'about.stage3.title': 'トレンド分析',
    'about.stage3.description': '独自のスコアリングアルゴリズムで複数チャートのリアルタイムトレンドを分析',
    'about.stage3.badge': 'マルチチャート分析',
    'about.features.title': '主要機能',
    'about.feature1.title': 'リアルタイムモニタリング',
    'about.feature1.description': 'Melon、Genie、Bugs、Vibe、FLO、Spotify、YouTube Music、Billboardのチャート変動をリアルタイムで追跡。',
    'about.feature2.title': 'ポートフォリオ管理',
    'about.feature2.description': '自分だけのK-POPポートフォリオを作成し、お気に入りアーティストのパフォーマンスを追跡。',
    'about.mission.title': '私たちのミッション',
    'about.mission.description': '世界中のK-POPファンに最も正確で速いチャート情報を提供し、K-POP文化のグローバル成長をサポートします。',
  },
  zh: {
    ...
    // About Page  
    'about.title': '介绍',
    'about.description': '基于Smart AI的实时K-POP排行榜监控平台',
    'about.hero.title1': '智能',
    'about.hero.title2': 'K-POP排行榜平台',
    'about.hero.description': 'KPOP Ranker实时监控全球K-POP排行榜，分析趋势，并通过AI技术提供洞察。',
    'about.tech.title': '核心技术',
    'about.stage1.title': '实时数据收集',
    'about.stage1.description': '每小时从全球8个音乐平台收集最新排行榜数据',
    'about.stage1.badge': '100%自动化',
    'about.stage2.title': '智能图像系统',
    'about.stage2.description': '6阶段智能匹配算法，0.05ms响应速度提供专辑图像',
    'about.stage2.badge': 'AI驱动',
    'about.stage3.title': '趋势分析',
    'about.stage3.description': '独特的评分算法分析多个排行榜的实时趋势',
    'about.stage3.badge': '多榜单分析',
    'about.features.title': '主要功能',
    'about.feature1.title': '实时监控',
    'about.feature1.description': '实时跟踪Melon、Genie、Bugs、Vibe、FLO、Spotify、YouTube Music、Billboard的排行榜变化。',
    'about.feature2.title': '收藏夹管理',
    'about.feature2.description': '创建专属的K-POP收藏夹，跟踪喜欢的艺人表现。',
    'about.mission.title': '我们的使命',
    'about.mission.description': '为全球K-POP粉丝提供最准确、最快速的排行榜信息，支持K-POP文化的全球发展。',
  }
};
